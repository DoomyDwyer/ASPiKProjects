...
IController* PluginGUI::createSubController(UTF8StringPtr name, const IUIDescription* description)
{
    ...
    findIt = strName.find("SimpleValueVariableToolTipKnobController");
	if (findIt >= 0)
	{
		// --- create the sub-controller
		auto* variableToolTipKnobController = new SimpleValueVariableToolTipKnobController(this, KNOB_FACTOR_GOES_TO_ELEVEN);
