...
private:
	...
	int filterType = 0;
	enum class filterTypeEnum { LPF1P,LPF1,HPF1,LPF2,HPF2,BPF2,BSF2,ButterLPF2,ButterHPF2,ButterBPF2,ButterBSF2,MMALPF2,MMALPF2B,LowShelf,HiShelf,NCQParaEQ,CQParaEQ,LWRLPF2,LWRHPF2,APF1,APF2,ResonA,ResonB,MatchLP2A,MatchLP2B,MatchBP2A,MatchBP2B,ImpInvLP1,ImpInvLP2 };	// to compare: if(compareEnumToInt(filterTypeEnum::LPF1P, filterType)) etc... 
