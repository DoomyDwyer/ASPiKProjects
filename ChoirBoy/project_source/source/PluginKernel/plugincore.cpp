...
bool PluginCore::reset(ResetInfo& resetInfo)
{
    ...
    // ---reset the chorus, with delay & lfo
    chorus.reset(resetInfo.sampleRate);
...
bool PluginCore::processAudioFrame(ProcessFrameInfo& processFrameInfo)
{
    ...
    else
    {
        ...
        return chorus.processAudioFrame(processFrameInfo.audioInputFrame,
...
bool PluginCore::initPluginParameters()
{
	...
	piParam = new PluginParameter(controlID::feedback_Pct, "Feedback", "%", controlVariableType::kDouble, -70.000000, 70.000000, 0.000000, taper::kLinearTaper);
	piParam->setParameterSmoothing(true);
	piParam->setSmoothingTimeMsec(20.00);
