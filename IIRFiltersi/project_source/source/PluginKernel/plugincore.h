...
private:
	...
	double filterFc_Hz = 1000.00000000;
	double filterQ = 0.70700000;
	double boostCut_dB = 0.00000000;
	...
	enum class filterTypeEnum
	{
		...
		ButterBPF2,ButterBSF2,MMALPF2,MMALPF2B,LowShelf,HiShelf,
		NCQParaEQ,CQParaEQ,LWRLPF2,LWRHPF2,APF1,APF2,ResonA,ResonB,
