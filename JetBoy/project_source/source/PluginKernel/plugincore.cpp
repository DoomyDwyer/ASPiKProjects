...
void PluginCore::updateParameters() {
    TimeModulatedDelayParameters params = flanger.getParameters();
    params.lfoDepth_Pct = lfoDepth_Pct;
    params.lfoRate_Hz = lfoRate_Hz;
    params.feedback_Pct = feedback_Pct;
    params.algorithm = timeModulatedDelayAlgorithm::kFlanger;
...
bool PluginCore::processAudioFrame(ProcessFrameInfo& processFrameInfo)
{
    ...
    else
    {
        ...
        return flanger.processAudioFrame(processFrameInfo.audioInputFrame,
...
bool PluginCore::initPluginParameters()
{
	...
	piParam = new PluginParameter(controlID::lfoRate_Hz, "Rate", "Hz", controlVariableType::kDouble, 0.020000, 20.000000, 0.200000, taper::kLinearTaper);
	...
	piParam = new PluginParameter(controlID::feedback_Pct, "Feedback", "%", controlVariableType::kDouble, -99.000000, 99.000000, 0.000000, taper::kLinearTaper);
	piParam->setParameterSmoothing(true);
	piParam->setSmoothingTimeMsec(20.00);
